...
GAS_SENSORS = [
  ...
  },
  {
    ...
    "device_class": SensorDeviceClass.GAS, # Change this to GAS if cubic meters is used
    "unit_of_measurement": VOLUME_CUBIC_METERS, # Might change to VOLUME_CUBIC_METERS soon
    "state_class": SensorStateClass.TOTAL_INCREASING,
    "icon": "mdi:fire",
